    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="admin.php"><svg height="30" width="200" xmlns="http://www.w3.org/2000/svg">
            <text x="50" y="20" fill="white">PPDB</text>
          </svg></a>
          <a class="sidebar-brand brand-logo-mini" href="admin.php"><svg height="30" width="200" xmlns="http://www.w3.org/2000/svg">
...
die("query Error :".mysqli_error($koneksi)."-".mysqli_error($koneksi));
        ...
        ?>
          ...
          <?php
// Di sini Anda bisa mendapatkan level pengguna dari sesi atau database
$level=$_SESSION['level'];
$user_level = "$level"; // Misalnya, di sini Anda menetapkan level pengguna sebagai "petugas"

// Tentukan menu yang perlu disembunyikan berdasarkan level pengguna
$menu_hidden = ($user_level === "petugas");
...
<li class="nav-item menu-items">
    ...
    <?php } ?>
    <div class="collapse <?php echo ($menu_hidden ? 'hide' : ''); ?>" id="ui-basic">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body ">
                    ...
                    <h6 class="font-weight-normal">Jumlah Pendaftar</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body ">
                    ...
                    <h6 class="font-weight-normal">Jumlah Jurusan</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body ">
                    ...
                    <h6 class="font-weight-normal">Daily Income</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body ">
                    ...
                    <h6 class="font-weight-normal">Expense current</h6>
                  </div>
                </div>
              </div>
            </div>
